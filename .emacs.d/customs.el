...
(custom-set-variables
 ...
 '(package-selected-packages
   '(markdown-mode markdown-preview-eww markdown-preview-mode evil-tutor howdoyou ample-theme dracula-theme doom-modeline org-babel-eval-in-repl flycheck-clang-analyzer magit magit-diff-flycheck acme-theme neotree subatomic-theme srcery-theme prettier-js company tide web-mode use-package shrink-path pdf-tools org-bullets org-beautify-theme nyan-mode mode-icons line-reminder emojify diff-hl auto-complete-exuberant-ctags auto-complete-clang-async all-the-icons))
